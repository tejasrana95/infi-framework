...
elseif(@$_GET['error']=='1049')
{
	echo '<div class="wrapper">'.$header.'
  <div class="desc">System is unable to find database. Please Check Database.</div>
</div>';
}
elseif(@$_GET['error']=='1044')
{
	echo '<div class="wrapper">'.$header.'
  <div class="desc">System is unable to login to sql server with your credentials. Please Check credentials.</div>
</div>';
}
